...
The bench is 59 Turkish CBAM-scope facilities: 34 cement (including Afyon Çimento, Batısöke Söke, Bursa Çimento, Göltaş Isparta), 16 steel, 3 aluminum, 6 fertilizer. Each row carries (a) facility identity (`id`, `company`, `cbam_scope`, `lat`, `lon`, `annual_capacity_t`), (b) a route tag for steel (`BF/BOF`, `EAF`, `DRI-EAF`), aluminum (`primary`, `downstream`), and fertilizer (`integrated`, `integrated-n2o-controlled`, `blender`), and (c) a CBAM customs-codes column for tariff bookkeeping.

We assemble three tiers of supervision:

1. **Strong labels (disclosure-grade, weight = 1.0)** — per-plant Scope 1 tCO₂e from operator integrated reports / sustainability disclosures / TSRS-compliant reports, with explicit `provenance ∈ {direct, allocated, composite, derived}` tag in `data/tr_facility_known_emissions.csv`. Audit-grade; `n = 21`: cement (Akçansa Büyükçekmece / Çanakkale / Ladik *allocated* from 2025 group total by clinker share; Nuh Hereke 2024 cement-only refined to 3,584,953 from TSRS p56; Afyon Çimento 2024 standalone TSRS; Batısöke Söke 2024 ISO 14064-verified; Göltaş Isparta 2024 TSRS; Bursa Çimento 2024 TSRS p59 ISO 14064-verified); steel (Çolakoğlu Dilovası 2024 EAF; Erdemir Ereğli 2024 IAR p79 *direct* 6,667,232; İsdemir İskenderun 2024 IAR p115; Kardemir Karabük 2023 SR p100; Habaş Aliağa 2024 SR composite EAF+plate-mill; İzdemir 2024 TSRS); aluminum (Assan Tuzla+Dilovası combined 2024; ASAŞ Akyazı 2024); fertilizer (Toros Mersin / Samsun / Ceyhan allocated from 2024 Tekfen TSRS group 842,174 by capacity; BAGFAŞ Bandırma 2024 TSRS; Gübretaş Yarımca 2024 TSRS). Source PDFs are cached under `data/disclosures/`. We report **headline metrics on three subsets** (all=21, direct-only=14, direct+composite=15) to confirm the result is not an artifact of allocated labels (§5.1: B1 reduction is 85.3% / 85.0% / 85.8% across the three subsets — robust).
