...
def render_page(fac: dict, beirle: dict | None, scenes: list[dict],
    ...
    if conformal:
        ...
        if ci_lo is not None and ci_hi is not None:
            ci_line = (f'<div class="ci-line">95% conformal prediction interval (formula, leave-one-plant-out, n=19): '
...
<footer class="footer">
  <p>iz · TR-MRV-Bench v0.4 · per-facility page generated by <code>bin/build_facility_pages.py</code> from
...
<div class="head">
  ...
  <div class="id">iz · TR-MRV-Bench v0.4<br>{html.escape(fid)}<br>Issued: {truth_year or '—'}</div>
</div>
